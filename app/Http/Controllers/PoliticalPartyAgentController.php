    ...
    public function index(Request $request)
    {
        ...
        if (request()->ajax()) {
            ...
            foreach ($list->items() as $idx => $row) {
                $action = '';
                $action .= '<a class="btn btn-xs btn-success col-3 mr-2" data-kt-table-filter="edit_row" href="'.url('/politicalpartyagents/view/'.$row['id']).' "><i class="fas fa-pencil-alt"></i></a>';
