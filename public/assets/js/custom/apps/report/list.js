...
var KTModalReport = function() {
    ...
    var closeForm = () => {
        ...
        // Private functions
    var initreportList = function(from_date='',to_date='') {
        // Set date data order
     ...
     $('#filterthis').click(function(){
        ...
        if(from_date!='' && to_date!=""){
            $('#kt_report_table').DataTable().destroy();
            initreportList(from_date,to_date);
        }else{
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function(e) {
                ...
                // Get report name
                const reportName = parent.querySelectorAll('td')[1].innerText;
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            success: function() {
                                ...
                                Swal.fire({
                                    text: "You have deleted " + reportName + "!.",
                                    icon: "success",
                                    buttonsStyling: false,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
                        ...
                        Swal.fire({
                            text: reportName + " was not deleted.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, got it!",
                            customClass: {
    ...
    var initToggleToolbar = () => {
        ...
        // Select elements
        const deleteSelected = document.querySelector('[data-kt-report-table-select="delete_selected"]');
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            jQuery("#loading").remove();
                            Swal.fire({
                                text: "You have deleted all selected report!.",
                                icon: "success",
                                buttonsStyling: false,
                                confirmButtonText: "Ok, got it!",
                                customClass: {
                    ...
                    Swal.fire({
                        text: "Selected report was not deleted.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
    ...
    const toggleToolbars = () => {
        // Define variables
        const toolbarBase = document.querySelector('[data-kt-report-table-toolbar="base"]');
        const toolbarSelected = document.querySelector('[data-kt-report-table-toolbar="selected"]');
        const selectedCount = document.querySelector('[data-kt-report-table-select="selected_count"]');
    ...
    return {
        ...
        init: function() {
            ...
            url = $("#kt_modal_add_report_form").attr("action");
            initreportList();
            initToggleToolbar();
