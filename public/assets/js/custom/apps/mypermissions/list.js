...
// Class definition
var KTModalPermission = function() {
    var cancelButton;
    var closeButton;
    var validator;
    var form;
    ...
    return {
        ...
        init: function() {
            ...
            form = document.querySelector('#kt_modal_add_mypermissions_form');
            cancelButton = form.querySelector('#kt_modal_add_mypermissions_cancel');
