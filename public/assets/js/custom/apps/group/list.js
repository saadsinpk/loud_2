...
var KTModalGroup = function() {
    ...
    var closeForm = () => {
        ...
        // Private functions
    var initgroupList = function(from_date='',to_date='') {
        // Set date data order
     ...
     $('#filterthis').click(function(){
        ...
        if(from_date!='' && to_date!=""){
            $('#kt_group_table').DataTable().destroy();
            initgroupList(from_date,to_date);
        }else{
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            success: function() {
                                ...
                                Swal.fire({
                                    text: "You have deleted " + groupName + "!.",
                                    icon: "success",
                                    buttonsStyling: false,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            jQuery("#loading").remove();
                            Swal.fire({
                                text: "You have deleted all selected group!.",
                                icon: "success",
                                buttonsStyling: false,
                                confirmButtonText: "Ok, got it!",
                                customClass: {
                    ...
                    Swal.fire({
                        text: "Selected group was not deleted.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
    ...
    const toggleToolbars = () => {
        // Define variables
        const toolbarBase = document.querySelector('[data-kt-group-table-toolbar="base"]');
        const toolbarSelected = document.querySelector('[data-kt-group-table-toolbar="selected"]');
        const selectedCount = document.querySelector('[data-kt-group-table-select="selected_count"]');
    ...
    return {
        // Public functions
        init: function() {
            modal = new bootstrap.Modal(document.querySelector('#kt_modal_add_group'));

            table = document.querySelector('#kt_group_table');

            if (!table) {
                return;
            }

            form = document.querySelector('#kt_modal_add_group_form');
            cancelButton = form.querySelector('#kt_modal_add_group_cancel');
            closeButton = form.querySelector('#kt_modal_add_group_close');
            url = $("#kt_modal_add_group_form").attr("action");
            initgroupList();
            initToggleToolbar();
