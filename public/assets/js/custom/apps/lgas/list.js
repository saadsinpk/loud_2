...
var KTModalLga = function() {
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-kt-lga-table-filter="search"]');
    ...
    var initToggleToolbar = () => {
        ...
        // Select elements
        const deleteSelected = document.querySelector('[data-kt-lga-table-select="delete_selected"]');
        ...
        deleteSelected.addEventListener('click', function() {
            ...
            console.log(ids);
            Swal.fire({
                text: "Are you sure you want to delete selected LGA?",
                icon: "warning",
                showCancelButton: true,
                buttonsStyling: false,
                confirmButtonText: "Yes, delete!",
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            jQuery("#loading").remove();
                            Swal.fire({
                                text: "You have deleted all selected LGA!.",
                                icon: "success",
                                buttonsStyling: false,
                                confirmButtonText: "Ok, got it!",
                                customClass: {
                    ...
                    Swal.fire({
                        text: "Selected lga was not deleted.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
