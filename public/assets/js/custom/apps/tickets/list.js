...
var KTModalticket = function() {
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[aria-controls="kt_tickets_table"]');
    ...
    $('#filterthis').click(function(){
            ...
            $('#kt_ticket_table').DataTable().destroy();
            initticketList();
    ...
    return {
        // Public functions
        init: function() {
            //modal = new bootstrap.Modal(document.querySelector('#kt_modal_add_ticket'));
			modal = $('#kt_modal_add_ticket');
			modalview = $('#kt_modal_view_ticket');
            table = document.querySelector('#kt_ticket_table');
            ...
            closeButton = form.querySelector('#kt_modal_add_ticket_close');
            url = $("#kt_modal_add_ticket_form").attr("action");
            initticketList();
            closeForm();
        }
    };
