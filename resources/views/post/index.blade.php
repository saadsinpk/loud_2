    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-post-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search..." />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    <!--begin::Toolbar-->
                    <div class="d-flex justify-content-end" data-kt-post-table-toolbar="base">
                        <!--begin::Add post-->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_post">Add post</button>
                        <!--end::Add post-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                    <div class="d-flex justify-content-end align-items-center d-none" data-kt-post-table-toolbar="selected">
                        <div class="fw-bolder me-5">
                        <span class="me-2" data-kt-post-table-select="selected_count"></span>Selected</div>
                        <button type="button" class="btn btn-danger" data-kt-post-table-select="delete_selected">Delete Selected</button>
                    </div>
                    <!--end::Group actions-->
                </div>
                <!--end::Card toolbar-->
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_post_table">
                    <!--begin::Table head-->
                    <thead>
                        <!--begin::Table row-->
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_post_table .form-check-input" value="1" />
                                </div>
                            </th>
                            <th class="min-w-125px">User</th>
                            <th class="min-w-125px">Group</th>
                            <th class="min-w-125px">Title</th>
                            <th class="min-w-125px">Total Comment</th>
                            <th class="min-w-125px">Total Likes</th>
        ...
        <div class="modal fade" id="kt_modal_add_post" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="{{ url('/post') }}" id="kt_modal_add_post_form" data-kt-redirect="{{ url('/post') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_add_post_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">Add a Post</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                            <div id="kt_modal_add_post_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <!--begin::Scroll-->
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_post_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_post_header" data-kt-scroll-wrappers="#kt_modal_add_post_scroll" data-kt-scroll-offset="300px">
                                <!--begin::Input group-->
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <textarea class="form-control form-control-lg form-control-solid" name="description">
                                    </textarea>
                                </div>
                                <!--end::Input group-->
                                ...
                                <!--begin::Input group-->
                                <!-- <div class="fv-row mb-7">
                                    <label class="form-label fw-bolder text-dark fs-6">Media</label>
                                    <input class="form-control form-control-lg form-control-solid" type="text" placeholder="/home/master/old/Videos/contact.png" name="media" autocomplete="off" />
                                </div> -->
                                <div class="fv-row mb-7">
                                    <label class="form-label fw-bolder text-dark fs-6">Media</label>
                                    <input class="form-control form-control-lg form-control-solid" type="file" name="media" autocomplete="off" />
                                </div>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select name="group_id" class="form-control form-control-solid" required>
                        ...
                        <div class="modal-footer flex-center">
                            <!--begin::Button-->
                            <button type="reset" id="kt_modal_add_post_cancel" class="btn btn-light me-3">Discard</button>
                            <!--end::Button-->
                            <!--begin::Button-->
        ...
        <div class="modal fade" id="kt_post_export_modal" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <!--begin::Modal title-->
                        <h2 class="fw-bolder">Export Post</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div id="kt_post_export_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="black" />
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        <!--begin::Form-->
                        <form id="kt_post_export_form" class="form" action="#">
                            <!--begin::Input group-->
                            ...
                            <div class="text-center">
                                <button type="reset" id="kt_post_export_cancel" class="btn btn-light me-3">Discard</button>
                                <button type="submit" id="kt_post_export_submit" class="btn btn-primary">
                                    <span class="indicator-label">Submit</span>
                                    <span class="indicator-progress">Please wait...
                                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                </button>
...
@section("after_script")
    ...
    <script src="{{ asset('public/assets/js/custom/apps/post/add.js') }}"></script>
    <script src="{{ asset('public/assets/js/custom/apps/post/list.js') }}"></script>
