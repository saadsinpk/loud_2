                    ...
                    <div class="modal fade" id="kt_modal_update_post" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                <!--begin::Form-->
                                <form class="form" action="{{ url('post/updateComment') }}" id="kt_modal_update_post_form" enctype="multipart/form-data" novalidate="novalidate" method="post">
                                    @csrf
                                    <input id="id" name="comment_id" type="hidden" value="{{ $postLike->id }}">
                                    <input id="id" name="post_id" type="hidden" value="{{ $postLike->post_id }}">
                                    <!--begin::Modal header-->
                                            ...
                                            <div id="kt_modal_update_post_post_info" class="collapse show">
				                                ...
				                                <div class="fv-row mb-7">
				                                    ...
				                                    <select name="status" class="form-control form-control-solid" required>
				                                        ...
				                                        <option @if($postLike->status  == 'LIKE') selected="selected" @endif  value="LIKE">LIKE</option>
				                                        <option @if($postLike->status  == 'DISLIKE') selected="selected" @endif  value="DISLIKE">DISLIKE</option>
