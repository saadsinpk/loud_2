                            ...
                            <div class="card mb-5 mb-xl-8">
                                ...
                                <div class="card-body pt-15">
                                    ...
                                    <div class="d-flex flex-center flex-column mb-5">
                                        ...
                                        <!--end::Avatar-->
                                        <!--begin::Name-->
                                        <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3">{{ $post->name }}</a>
                                        <!--end::Name-->
                                        <div class="mb-9">
                                            <!--begin::Badge-->
                                            <div class="badge badge-light-primary d-inline">Post</div>
                                            <!--begin::Badge-->
                                        </div>
                                    ...
                                    <div id="kt_post_view_details" class="collapse show">
                                        <div class="py-5 fs-6">
                                            ...
                                            <input type="hidden" id="post_detail_id" value="{{ $post->id }}">
                    ...
                    <div class="modal fade" id="kt_modal_update_post" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                <!--begin::Form-->
                                <form class="form" action="{{ url('post/update') }}" id="kt_modal_update_post_form" enctype="multipart/form-data" novalidate="novalidate" method="post">
                                    @csrf
                                    <input id="id" name="id" type="hidden" value="{{ $post->id }}">
                                    <!--begin::Modal header-->
                                    <div class="modal-header" id="kt_modal_update_post_header">
                                        <!--begin::Modal title-->
                                        <h2 class="fw-bolder">Update post</h2>
                                        <!--end::Modal title-->
                                        <!--begin::Close-->
                                        ...
                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_post_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_post_header" data-kt-scroll-wrappers="#kt_modal_update_post_scroll" data-kt-scroll-offset="300px">
                                            ...
                                            <div id="kt_modal_update_post_post_info" class="collapse show">
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="text" class="form-control form-control-solid" placeholder="" name="title" value="{{ $post->title }}" />
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <textarea class="form-control form-control-lg form-control-solid" name="description">{{ $post->description }}
                                                    </textarea>
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <select name="user_id" class="form-control form-control-solid" required>
                                                        ...
                                                        @foreach($users  as $user)
                                                          <option @if($post->user_id  == $user->id) selected="selected" @endif value="{{$user->id}}">{{$user->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    <!--end::Input-->
                                                </div>
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <select name="group_id" class="form-control form-control-solid" required>
                                                        ...
                                                        @foreach($groups  as $group)
                                                          <option @if($post->group_id  == $group->id) selected="selected" @endif value="{{$group->id}}">{{$group->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    <!--end::Input-->
                                                </div>
    ...
    @section("after_script")
        ...
        <script src="{{ asset('public/assets/js/custom/apps/post/update.js') }}"></script>
