...
@section("content")
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="modal fade" id="kt_modal_add_mypermissions" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="{{ url('/admin/mypermissions') }}" id="kt_modal_add_mypermissions_form" data-kt-redirect="{{ url('/admin/mypermissions') }}" method="POST">
                        @csrf
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_add_mypermissions_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">Create New Permission</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                            <div id="kt_modal_add_mypermissions_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <!--begin::Scroll-->
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_mypermissions_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_mypermissions_header" data-kt-scroll-wrappers="#kt_modal_add_mypermissions_scroll" data-kt-scroll-offset="300px">
                                <!--begin::Input group-->
                        ...
                        <div class="modal-footer flex-center">
                            <!--begin::Button-->
                            <button type="reset" id="kt_modal_add_mypermissions_cancel" class="btn btn-light me-3">Discard</button>
                            <!--end::Button-->
                            <!--begin::Button-->
...
@section("after_script")
    ...
    <script src="{{ asset('assets/js/custom/apps/mypermissions/add.js') }}"></script>
    <script src="{{ asset('assets/js/custom/apps/mypermissions/list.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/js/bootstrap-datepicker.min.js" integrity="sha512-T/tUfKSV1bihCnd+MxKD0Hm1uBBroVYBOYSk1knyvQ9VyZJpc/ALb4P0r6ubwVPSGB2GvjeoMAJJImBG12TiaQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        ...
        <script>$(".datepicker").datepicker({dateFormat: 'yy-mm-dd'});
        </script>
