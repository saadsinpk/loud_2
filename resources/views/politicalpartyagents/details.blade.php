    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="d-flex flex-column flex-xl-row">
                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-body pt-15">
                                ...
                                <div class="d-flex flex-center flex-column mb-5">
                                    ...
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3">{{ $politicalpartyagent->name }}</a>
                                    <!--end::Name-->
                                    <div class="mb-9">
                                        <!--begin::Badge-->
                                        <div class="badge badge-light-primary d-inline">political part yagent</div>
                                        <!--begin::Badge-->
                                    </div>
                                ...
                                <div class="d-flex flex-stack fs-4 py-3">
                                    <div class="fw-bolder rotate collapsible" data-bs-toggle="collapse" href="#kt_politicalpartyagent_view_details" role="button" aria-expanded="false" aria-controls="kt_politicalpartyagent_view_details">Details
                                    <span class="ms-2 rotate-180">
                                        ...
                                        <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit politicalpartyagent details">
                                            <a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_update_politicalpartyagent">Edit</a>
                                        </span>
                                ...
                                <div id="kt_politicalpartyagent_view_details" class="collapse show">
                                    <div class="py-5 fs-6">
                                        <!--begin::Details item-->
                                        <div class="fw-bolder"></div>
                                        <div class="text-gray-600">
										<img src="{{url('public/uploads/agent_images/'.$politicalpartyagent->agent_picture)}}" />
										</div>
                                        <!--begin::Details item-->
										
                                        <!--begin::Details item-->
                                        <div class="fw-bolder">Name</div>
                                        <div class="text-gray-600">{{ $politicalpartyagent->Name }}</div>
                                        <!--begin::Details item-->
                                        <!--begin::Details item-->
                                        <div class="fw-bolder mt-5">Created Time</div>
                                        <div class="text-gray-600">{{ $politicalpartyagent->created_at->format("d M Y, g:i A") }}</div>
                                        <input type="hidden" id="id" value="{{ $politicalpartyagent->id }}">
                    ...
                    <div class="flex-lg-row-fluid ms-lg-15">
                        ...
                        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                            <!--begin:::Tab item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_politicalpartyagent_security">Security</a>
                            </li>
                            <!--end:::Tab item-->
                        ...
                        <div class="tab-content" id="myTabContent">
                            <!--begin:::Tab pane-->
                            <div class="tab-pane fade show active" id="kt_politicalpartyagent_security" role="tabpanel">
                                <!--begin::Card-->
                                            ...
                                            <table class="table align-middle table-row-dashed gy-5" id="kt_table_users_login_session">
                                                ...
                                                <tbody class="fs-6 fw-bold text-gray-600">
                                                    <tr>
                                                        ...
                                                        <td>{{ $politicalpartyagent->political_party }}</td>
                                                        <td class="text-end">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>LGA</td>
                                                        <td>{{ $politicalpartyagent->lga->name }}</td>
                                                        <td class="text-end">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>Ward</td>
                                                        <td>{{ $politicalpartyagent->ward->name }}</td>
                                                        <td class="text-end">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>PU</td>
                                                        <td>{{ $politicalpartyagent->pollingUnit->name }}</td>
                                                        <td class="text-end">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>designation</td>
                                                        <td>{{ $politicalpartyagent->designation }}</td>
                                                        <td class="text-end">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>Home Address</td>
                                                        <td>{{ $politicalpartyagent->home_address }}</td>
                                                        <td class="text-end">
                                                        </td>
                                                    </tr>
													...
													<tr>
													                                                    <tr>
                                                        <td>Mobile</td>
                                                        <td>{{ $politicalpartyagent->moile }}</td>
                                                        <td class="text-end">
                                                        </td>
                                                    </tr>
													
													<tr>                                                    <tr>
                                                        <td>Extra Mobile No.</td>
                                                        <td>{{ $politicalpartyagent->extra_mobile }}</td>
                                                        <td class="text-end">
                                                        </td>
                                                    </tr>
													...
													<tr>                                                    <tr>
													 ...
													 <tr>                                                   <tr>
                                                        <td>Name_electoral_officer</td>
                                                        <td>{{ $politicalpartyagent->name_electoral_officer }}</td>
                                                        <td class="text-end">
                                                        </td>
                                                    </tr>
                ...
                <div class="modal fade" id="kt_modal_update_politicalpartyagent" tabindex="-1" aria-hidden="true">
                    <!--begin::Modal dialog-->
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_politicalpartyagent_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_politicalpartyagent_header" data-kt-scroll-wrappers="#kt_modal_update_politicalpartyagent_scroll" data-kt-scroll-offset="300px">
										...
										<!--end::Input group-->
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input id="name" type="text" class="form-control form-control-solid" placeholder="" name="name" value="{{ $politicalpartyagent->name }}"  autocomplete="off"/>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
