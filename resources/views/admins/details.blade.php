                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-body pt-15">
                                ...
                                <div class="d-flex flex-center flex-column mb-5">
                                    ...
                                    <div class="mb-9">
                                        <!--begin::Badge-->
                                        <div class="badge badge-light-primary d-inline">Administrator</div>
                                        <!--begin::Badge-->
                                    </div>
                                ...
                                <div class="d-flex flex-stack fs-4 py-3">
                                    ...
                                    @can('edit')
                                        <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit admin details">
                                            <a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_update_admin">Edit</a>
                                        </span>
                                    @endcan
                                </div>
                                <!--end::Details toggle-->
                        ...
                        <div class="modal-content">
                            ...
                            <form class="form" action="{{ url('admins/update') }}" id="kt_modal_update_admin_form" enctype="multipart/form-data" novalidate="novalidate">
                                ...
                                <div class="modal-header" id="kt_modal_update_admin_header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bolder">Update admin</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_update_password_form" class="form" action="{{ url('admins/update') }}">
                                    <div class="fv-row mb-7">
