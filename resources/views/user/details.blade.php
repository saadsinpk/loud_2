                ...
                <div class="d-flex flex-column flex-xl-row">
                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-body pt-15">
                                ...
                                <div class="d-flex flex-center flex-column mb-5">
                                    ...
                                    <div class="mb-9">
                                        <!--begin::Badge-->
                                        <div class="badge badge-light-primary d-inline">User</div>
                                        <!--begin::Badge-->
                                    </div>
                                ...
                                <div id="kt_user_view_details" class="collapse show">
                                    <div class="py-5 fs-6">
                                        ...
                                        <input type="hidden" id="user_detail_id" value="{{ $user->id }}">
                    ...
                    <div class="flex-lg-row-fluid ms-lg-15">
                        ...
                        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                            <!--begin:::Tab item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_user_security">Security</a>
                            </li>
                            <!--end:::Tab item-->
                        ...
                        <div class="tab-content" id="myTabContent">
                            <!--begin:::Tab pane-->
                            <div class="tab-pane fade show active" id="kt_user_security" role="tabpanel">
                                <!--begin::Card-->
...
@section("after_script")
    ...
    <script src="{{ asset('assets/js/custom/apps/user/update.js') }}"></script>
