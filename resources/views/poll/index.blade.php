    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-poll-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search..." />
                    </div>
                    <!--end::Search-->
                </div>
                <!-- <form action="{{ url('/filter') }}"class="form-inline" method="post" accept-charset="utf-8"> -->
                <!-- @csrf -->
                ...
                <div class="card-toolbar">
                    <!--begin::Toolbar-->
                    <div class="d-flex justify-content-end" data-kt-poll-table-toolbar="base">
                        <!--begin::Add poll-->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_poll">Add poll</button>
                        <!--end::Add poll-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                    <div class="d-flex justify-content-end align-items-center d-none" data-kt-poll-table-toolbar="selected">
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_poll_table">
                    <!--begin::Table head-->
                    <thead>
                        <!--begin::Table row-->
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_poll_table .form-check-input" value="1" />
                                </div>
                            </th>
                            <th class="min-w-125px">User</th>
                            <th class="min-w-125px">Quesiton</th>
                            <th class="min-w-125px">Total Votes</th>
        ...
        <div class="modal fade" id="kt_modal_add_poll" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="{{ url('/poll') }}" id="kt_modal_add_poll_form" data-kt-redirect="{{ url('/poll') }}" method="POST">
                        @csrf
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_add_poll_header">
                            <!--begin::Modal title-->
                            <input type="hidden" name="date_filter" value="<?php echo date("m/d/Y")?>">
                            <h2 class="fw-bolder">Add a Poll</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                            <div id="kt_modal_add_poll_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <!--begin::Scroll-->
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_poll_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_poll_header" data-kt-scroll-wrappers="#kt_modal_add_poll_scroll" data-kt-scroll-offset="300px">
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" placeholder="" name="question" value="" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" class="form-control form-control-solid" placeholder="" name="endsin" value="" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="fv-row mb-7 option_div">
                                    ...
                                    <div class="option_copy option_count">
                                        ...
                                        <input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="options[]" autocomplete="off" />
                                ...
                                <div class="fv-row mb-7" for="is_people_share">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="is_people_share" value="1" checked="checked" />
                                ...
                                <div class="fv-row mb-7" for="hide_creator_details">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="hide_creator_details" value="1" checked="checked" />
                        ...
                        <div class="modal-footer flex-center">
                            <!--begin::Button-->
                            <button type="reset" id="kt_modal_add_poll_cancel" class="btn btn-light me-3">Discard</button>
                            <!--end::Button-->
                            <!--begin::Button-->
        ...
        <div class="modal fade" id="kt_poll_export_modal" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <!--begin::Modal title-->
                        <h2 class="fw-bolder">Export Poll</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div id="kt_poll_export_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="black" />
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        <!--begin::Form-->
                        <form id="kt_poll_export_form" class="form" action="#">
                            <!--begin::Input group-->
                            ...
                            <div class="text-center">
                                <button type="reset" id="kt_poll_export_cancel" class="btn btn-light me-3">Discard</button>
                                <button type="submit" id="kt_poll_export_submit" class="btn btn-primary">
                                    <span class="indicator-label">Submit</span>
                                    <span class="indicator-progress">Please wait...
                                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                </button>
...
@section("after_script")
    ...
    <script src="{{ asset('public/assets/js/custom/apps/poll/add.js') }}"></script>
    <script src="{{ asset('public/assets/js/custom/apps/poll/list.js') }}"></script>
