        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6 d-flex justify-content-end">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{route('superAdmins.index')}}" class="btn btn-info btn-sm"><i class="fas fa-menu"></i> Back to List</a>
                </div>
                <!--end::Card toolbar-->
            </div>
            <!--end::Card header-->
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                  ...
                  <form method="POST" action="{{route('superAdmins.update', encrypt($user->id))}}">
                        @csrf
