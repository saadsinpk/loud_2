...
@section("content")
            ...
            <div class="row">
                ...
                <!--begin::Toolbar-->
                    <div class="form-group col-md-1 col-sx-12 col-ms-12" data-kt-user-table-toolbar="base">
                        <!--begin::Add user-->
                        <button type="button" class="btn btn-danger  btn_margin " data-toggle="modal" data-target="#kt_modal_add_pollingunit">Add New</button>
                        <!--end::Add user-->
                    </div>
                    <!--end::Toolbar-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_pollingunits_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Delimitation Code</th>
                            
                            <th class="min-w-125px">State</th>
                            <th class="min-w-125px">Local Goverment</th>
        ...
        <div class="modal fade" id="kt_modal_add_pollingunit" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="{{ url('/admin/pollingunits') }}" id="kt_modal_add_pollingunit_form" data-kt-redirect="{{ url('/admin/pollingunits') }}" method="POST">
                        @csrf
                        <!--begin::Modal header-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <!--begin::Scroll-->
                            <div class=" me-n7 pe-7" id="kt_modal_add_pollingunit_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_pollingunit_header" data-kt-scroll-wrappers="#kt_modal_add_pollingunit_scroll" data-kt-scroll-offset="0">
                                <!--begin::Input group-->
 ...
 <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-bold mb-2">Local Government</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" placeholder="" name="local_government" value="" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
								<!--begin::Input group-->
              ...
              <div class="modal-content">
                ...
                <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                    ...
                    <p class="text-muted text-center"><span id="local_government"></span></p>
                    <p class="text-muted text-center"><span id="ward_name"></span></p>
                    <p class="text-muted text-center"><span id="lga_name"></span></p>
                    <p class="text-muted text-center"><span id="ward_name"></span></p>
