      ...
      <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
				...
				<!--begin::Toolbar-->
                    <div class="form-group col-md-1 col-sx-12 col-ms-12" data-kt-user-table-toolbar="base">
                        <!--begin::Add user-->
                        <button type="button" class="btn btn-danger  btn_margin " data-toggle="modal" data-target="#kt_modal_add_election">Add New</button>
                        <!--end::Add user-->
                    </div>
                    <!--end::Toolbar-->
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_election_table">
                    <!--begin::Table head-->
                    <thead>
                        <!--begin::Table row-->
        ...
        <!--begin::Modal - admins - View -->
		  <div class="modal fade" id="kt_modal_view_election">
        ...
        <!--begin::Modal - election - Add-->
        <div class="modal fade" id="kt_modal_add_election" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="{{ url('/admin/elections') }}" id="kt_modal_add_election_form" data-kt-redirect="{{ url('/admin/elections') }}" method="POST">
                        @csrf
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_add_election_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">Add a Election</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                            <div id="kt_modal_add_election_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <!--begin::Scroll-->
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_election_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_election_header" data-kt-scroll-wrappers="#kt_modal_add_election_scroll" data-kt-scroll-offset="300px">
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" placeholder="Election Name" name="name" value="" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                        ...
                        <div class="modal-footer flex-center">
                            <!--begin::Button-->
                            <button type="reset" id="kt_modal_add_election_cancel" class="btn btn-light me-3">Discard</button>
                            <!--end::Button-->
                            <!--begin::Button-->
...
<script src="{{ asset('assets/js/plugins/datatables-buttons/js/buttons.colVis.min.js') }}"></script>
    ...
    <script src="{{ asset('assets/js/custom/apps/elections/add.js') }}"></script>
    <script src="{{ asset('assets/js/custom/apps/elections/list.js') }}"></script>
