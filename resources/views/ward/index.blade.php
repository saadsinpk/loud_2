            ...
            <div class="card-header border-0 pt-6">
                ...
                <!--begin::Toolbar-->
                    <div class="form-group col-md-1 col-sx-12 col-ms-12" data-kt-user-table-toolbar="base">
                        <!--begin::Add user-->
                        <button type="button" class="btn btn-danger  btn_margin " data-toggle="modal" data-target="#kt_modal_add_ward">Add New</button>
                        <!--end::Add user-->
                    </div>
                    <!--end::Toolbar-->
        ...
        <div class="modal fade" id="kt_modal_add_ward" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="{{ url('/admin/wards') }}" id="kt_modal_add_ward_form" data-kt-redirect="{{ url('/admin/wards') }}" method="POST">
                        @csrf
                        <!--begin::Modal header-->
