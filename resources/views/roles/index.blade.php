            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="form-group col-md-3 col-sx-12 col-ms-12">
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" data-kt-role-table-filter="search" name="searchword" id="searchword" class="form-control" placeholder="Search..." />
                ...
                <!--begin::Toolbar-->
                    <div class="form-group col-md-1 col-sx-12 col-ms-12" data-kt-role-table-toolbar="base">
                        <!--begin::Add user-->
                        <button type="button" class="btn btn-danger  btn_margin " data-toggle="modal" data-target="#kt_modal_add_role">Add New</button>
                        <!--end::Add user-->
                    </div>
                    <!--end::Toolbar-->
                </div>
              ...
              <div class="modal-content">
                ...
                <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                    ...
                    <h2 class="profile-username text-left"><strong>Permissions:</strong></h2>
                    <h6 class="profile-username text-left"><span id="permissions_view"></span></h6>
